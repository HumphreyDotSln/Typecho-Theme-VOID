            ...
            <div class="container wider">
                <nav>
                    ...
                    <?php if ($setting['nav']) {
                        ...
                        <?php endif; ?>
                        <a <?php if (Utils::isPluginAvailable('ExSearch')) echo 'class="search-form-input" style="display:flex"'; ?> role=button aria-label="展开搜索" id="toggle-mobile-search" target="_self" href="javascript:void(0);" onclick="<?php if (!Utils::isPluginAvailable('ExSearch')) echo 'VOID_Ui.toggleSearch(this);'; ?>">
