...
gulp.task('pack:css:dep', function ()
{
    return gulp.src(['./assets/libs/**/*.css', '!./assets/libs/mathjax/**/*'])
        ...
        .pipe(minify())
        .pipe(rev())
        .pipe(gulp.dest('../Typecho-Theme-VOID-nightly/assets/'))
        .pipe(rev.manifest())
...
gulp.task('md5', function ()
{
    return gulp.src(['temp/rev/**/*.json', './**/*.php'])
        .pipe(revCollector())
        .pipe(gulp.dest('../Typecho-Theme-VOID-nightly/'));
});
...
gulp.task('move', function ()
{
    gulp.src(['./assets/libs/owo/**/*', './assets/libs/mathjax/**/*'], { base: './assets/libs/' })
        .pipe(gulp.dest('../Typecho-Theme-VOID-nightly/assets/libs/'));
    gulp.src(['./assets/sw-toolbox.js', './assets/VOIDCacheRule.js'])
        .pipe(gulp.dest('../Typecho-Theme-VOID-nightly/assets/'));
    gulp.src(['./assets/fonts/*'])
        .pipe(gulp.dest('../Typecho-Theme-VOID-nightly/assets/fonts/'));
